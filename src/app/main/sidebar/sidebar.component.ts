...
export class SidebarComponent implements OnInit {
  ...
  headers:any[]=[
    ...
    {id:1,name:'equipment', active: false, icon:'date_range', children:['Calendar','Time Line', 'Reservation History','Usage History', 'User Training'  ]},
    {id:2,name:'event and alert', active: false, icon:'messages', children:[]},
    {id:3,name:'loan desk', active: false, icon:'flip', children:['Loan Desk','Assign User ID Card to user','Loanable Equipment List','Loan Desk settings']},
    {id:4,name:'request service', active: false, icon:'flash_on', children:['Sample Requests','Requests Lines Management', 'Requests Lines Management Configuration']},
    ...
    {id:10,name:'messages', active: false, icon:'volume_down', children:['Send Email to Users','Calendar Messages','Dashboard Announcement']},
  ...
  headersAdmin: any[]=[
    ...
    {id:14,name:'equipment', active: false, icon:'date_range', children:['Calendar','Time Line', 'Reservation History','Usage History', 'User Training'  ]},
